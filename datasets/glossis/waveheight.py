...
def glossis_waveheight_to_tiff(bucketname, prefixname, tmpdir):
    ...
    netcdfs = download_netcdfs_from_bucket(bucketname, prefixname, tmpdir, "NOAA_WW3_fc")
...
if __name__ == '__main__':
    print(glossis_waveheight_to_tiff("dgds-data", "fews_glossis/", "/input/data/waveheight"))
