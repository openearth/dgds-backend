...
def dflowgrid2tri(mesh2d_face_nodes):
    """Convert the irregular grid from a D-flow FM simulation
...
if __name__ == '__main__':
    ...
    bucket = storage_client.get_bucket(args.bucket[0])
    blobs = storage_client.list_blobs(bucket)
    blobs = list(storage_client.list_blobs(bucket, prefix=args.prefix[0]))
